...
- [ ] 1.1. Create cpal engine module structure
  - Status: in_progress
...
- [ ] 1.2. Implement cpal audio callbacks
  - Status: in_progress
  - File: `rust/src/audio/engine_cpal.rs`
...
- [ ] 1.3. Implement start/stop and lifecycle methods
  - File: `rust/src/audio/engine_cpal.rs`
...
- [ ] 2.1. Expose cpal engine in module tree
...
- [ ] 2.2. Switch engine selection logic
...
- [ ] 2.3. Verify compilation on Linux
